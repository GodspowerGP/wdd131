...
const temples = [
  ...
  },
  {
    ...
    area: 53997,
    imageUrl:
    "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/tokyo-japan/400x250/tokyo_japan_temple-evening.jpg"
  }
];
...
navLinks.forEach(link => {
    link.addEventListener("click", (e) => {
        ...
        let filter = link.getAttribute("title");
        let filtered = [];
        ...
        if (filter === "Old") {
            ...
            filtered = temples; // Home or default
        }
